...
const signTokenWithPolicyPermissions = (s3Params, roleToSignToken, tokenRequesterInformation, SecretId, expiryDurationOfToken) => {
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      const token = await generateTokenWithSecretsManager(SecretId, tokenPayload, expiryDurationOfToken)
